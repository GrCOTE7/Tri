...
class chat:
    ...
    def __eq__(self, other):
        if self.color == other.color and \
            self.neutered == other.neutered and \
    ...
    def __lt__(self, other):
        ...
        elif self.neutered_priority[self.neutered] != self.neutered_priority[other.neutered]:
            return self.neutered_priority[self.neutered] < self.neutered_priority[other.neutered]
